...
export const createOrUpdateStepperStepProg = async (
  ...
  { percentDone, isCompleted, stepId }: CreateOrUpdateStepperStepProgInput
...
Promise<any> => {
  ...
  let stepperProg =
    matchedStepperProgs.length > 0 ? matchedStepperProgs[0] : null;
  ...
  let stepperStepProg =
    matchedStepperStepProgs.length > 0 ? matchedStepperStepProgs[0] : null;
